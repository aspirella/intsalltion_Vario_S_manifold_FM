...
function renderStep(index) {
    ...
    // New: Toggle Large Visual Mode for Installation, Flushing, and Dimensions
    const videoContainer = document.querySelector('.video-player-container');
    if (videoContainer) {
        if (step.category === 'installation' || step.category === 'flushing' || step.id === 2) {
            videoContainer.classList.add('large-visual-mode');
        } else {
